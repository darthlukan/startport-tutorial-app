...
import { Post } from "../starporttutorialapp/post";
...
export class QueryClientImpl {
    ...
    Post(request) {
        ...
        const promise = this.rpc.request("darthlukan.starporttutorialapp.starporttutorialapp.Query", "Post", data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request("darthlukan.starporttutorialapp.starporttutorialapp.Query", "PostAll", data);
